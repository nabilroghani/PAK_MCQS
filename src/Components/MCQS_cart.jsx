...
import { mcqCategories, mcqSubcategory1 } from "../assets/category.js";
    ...
    <div className="p-4 md:p-8 bg-gray-100 min-h-screen flex justify-center">
      ...
      <div className="hidden md:block md:w-1.5/5 pl-6 ">
        <div className=" bg-white shadow-lg rounded-xl p-6">
          {/* Dropdown Header */}
          <div
            onClick={() => toggleDropdown("pakmcqs")}
            className="flex justify-between items-center cursor-pointer"
          >
            <Title text="PAKMCQS MENU" />
            {openMenu === "pakmcqs" ? (
